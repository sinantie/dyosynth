...
void updateDisplay() {
  ...
  _shiftOut(ENCODER_LED_DATA_PIN, ENCODER_LED_CLK_PIN, leds[1]); 
  //count down on RED LEDs
  _shiftOut(ENCODER_LED_DATA_PIN, ENCODER_LED_CLK_PIN, leds[0]);
...
void showPageParameters(SYNTH_PAGE page) {
  // TODO
}